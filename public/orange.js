...
function pageOrange() {
  ...
  app.innerHTML = `<section class="orange-story" aria-labelledby="story-title">
    ...
    <p>Écoute, réécoute et lis les paroles. Fais dialoguer les morceaux pour découvrir les différentes lectures qu’ils contiennent. Puis rends-toi sur la <a href="/echelon" data-link>page Échelon</a> pour proposer les signes que tu as trouvés et progresser dans l’escape game.</p></div>
  </section>`;
}
...
function pageMusique() {
  ...
  </section><p class="album-game-link"><a href="/echelon" data-link>Le jeu se poursuit dans Échelon →</a></p>`;
  bindMusicButtons();
}
